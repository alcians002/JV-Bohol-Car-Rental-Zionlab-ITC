...
<head>
    ...
    <title>Settings — JV Bohol Car Rental Admin</title>
...
<body>
    ...
    <aside class="admin-sidebar d-flex flex-column p-3" id="adminSidebar">
        ...
        <?php $currentPage = $_GET['page'] ?? 'settings'; ?>
    ...
    <main class="admin-main">
        ...
        <div
            ...
            <div>
                ...
                <p class="mb-0 small" style="color: var(--admin-muted);">Configure application preferences and user
                    accounts.</p>
            </div>
        </div>
        ...
        <div class="card bg-dark border-0 rounded-4 shadow-sm h-100 d-flex align-items-center justify-content-center p-5 text-center"
            ...
            <div>
                ...
                <h3 class="h5 fw-bold text-white mb-2">Settings Module Coming Soon</h3>
                <p class="text-muted mb-0 small" style="max-width: 300px; margin: 0 auto;">
                    This section will allow you to update administrative credentials, site preferences, and email
                    templates.
                </p>
            </div>
        </div>
